...
const FileUpload = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-100">File Upload & Execution</h1>
        <p className="text-gray-400 mt-1">Upload CSV files to start a new migration</p>
      </div>
      ...
      <Card className="bg-gray-900 border-gray-800">
        ...
        <CardContent>
          ...
          >
            ...
            <p className="text-lg text-gray-300 mb-2">Drop your CSV files here</p>
          ...
          {files.length > 0 && (
            <div className="mt-6 space-y-3">
              <h3 className="text-lg font-medium text-gray-100">Selected Files</h3>
          ...
          {uploadStatus === "success" && (
            <Alert className="mt-6 bg-green-900/50 border-green-600">
              ...
              <AlertDescription className="text-green-300">
                Files uploaded successfully! Migration workflow has been triggered.
              </AlertDescription>
            </Alert>
          )}
        ...
        <CardContent>
          <div className="space-y-3 text-gray-300">
            <div className="flex items-start space-x-2">
              <Badge className="bg-purple-900/50 text-purple-400 border-purple-600 mt-0.5">CSV</Badge>
              <span>Only CSV files are supported for migration</span>
            </div>
            <div className="flex items-start space-x-2">
              <Badge className="bg-blue-900/50 text-blue-400 border-blue-600 mt-0.5">SIZE</Badge>
              <span>Maximum file size is 100MB per file</span>
            </div>
            <div className="flex items-start space-x-2">
              <Badge className="bg-green-900/50 text-green-400 border-green-600 mt-0.5">FORMAT</Badge>
              <span>Ensure your CSV has proper headers and UTF-8 encoding</span>
            </div>
            <div className="flex items-start space-x-2">
              <Badge className="bg-orange-900/50 text-orange-400 border-orange-600 mt-0.5">CONFIG</Badge>
              <span>Make sure your mapping.json configuration is set up correctly</span>
            </div>
          </div>
        </CardContent>
      </Card>
